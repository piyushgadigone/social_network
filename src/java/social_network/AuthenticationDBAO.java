...
public class AuthenticationDBAO {
           ...
           throws ClassNotFoundException, SQLException
   {
       ...
       try {
           ...
           while (resultSet.next()) {
                if(authentication.getHashedPassword().equals(resultSet.getString("password"))) {
   ...
   public static void createPatient (String login) 
           throws ClassNotFoundException, SQLException
   {
       Connection con = null;
       Statement stmt = null;
   ...
   public static void createDoctor (String login) 
           throws ClassNotFoundException, SQLException
   {
       Connection con = null;
       Statement stmt = null;
